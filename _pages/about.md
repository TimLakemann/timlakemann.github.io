...
The goal of my PhD is to develop a decentralized framework that allows agile UAV swarms to operate safely and efficiently in cluttered environments using only onboard sensing and computation.
